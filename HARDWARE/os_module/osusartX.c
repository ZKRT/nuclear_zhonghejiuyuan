...
USART_TypeDef* UsartInstance[USART_MAX_INDEX] = {USART1, USART6}; //zkrt_notice: 根据芯片自定义
const uint32_t uart_baudrate[USART_MAX_INDEX] ={115200, 115200} ;//zkrt_notice: 根据芯片自定义
...
/**
  ...
  * @retval None
  */
void USART1_IRQHandler(void) //zkrt_notice: 根据芯片自定义
{
